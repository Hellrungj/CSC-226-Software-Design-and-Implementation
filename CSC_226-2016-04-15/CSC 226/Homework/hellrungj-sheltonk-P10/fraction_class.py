...
class Fraction:
    ...
    def add_fraction( self, fraction_to_add ):
        '''Given a Fraction object (fraction_to_add) as input, add it to itself so that it
        becomes the sum of what it had and what was inputted.
        ...
        self.numerator=(self.numerator*fraction2.denominator)
        self.denominator=(self.denominator*fraction2.denominator)
