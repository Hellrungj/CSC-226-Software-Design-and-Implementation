...
#Dr. Mario Nakazawa
#-------------------------------------------------------------------------------
#Have probelm with code please help me(line 71), I submitt two pices of code becasue the code works but I cann't get the def part to work.
import time
...
if YESorNO == "yes" or YESorNO == "Yes":
    ...
    def john(map[int, str[T]):
#Having troble with def(don;t know what I am doing wrong.)
    T = birthY
    Year = T.sum
    #LiveNumber
    time.sleep(1.0)
